...
/**
 * ==============================================
 * MiroTalk P2P v.1.8.81 - Configuration File
 * ==============================================
 *
...
module.exports = {
    ...
    brand: {
        ...
        app: {
            ...
            name: appName,
            title: `<h1>${appName}</h1>Free browser based Real-time video calls.<br />Simple, Secure, Fast.`,
            description:
        ...
        site: {
            ...
            landingTitle: `${appName} a Free Secure Video Calls, Chat & Screen Sharing.`,
            newCallTitle: `${appName} a Free Secure Video Calls, Chat & Screen Sharing.`,
            newCallRoomTitle: 'Pick name. <br />Share URL. <br />Start conference.',
            newCallRoomDescription:
                "Each room has its disposable URL. Just pick a room name and share your custom URL. It's that easy.",
            loginTitle: `${appName} - Host Protected login required.`,
            loginHeading: 'Welcome back',
            loginDescription: 'Enter your credentials to continue.',
            loginButtonLabel: 'Login',
            joinRoomTitle: 'Pick name.<br />Share URL.<br />Start conference.',
            joinRoomButtonLabel: 'JOIN ROOM',
            clientTitle: `${appName} WebRTC Video call, Chat Room & Screen Sharing.`,
            privacyPolicyTitle: `${appName} - privacy and policy.`,
            stunTurnTitle: 'Test Stun/Turn Servers.',
            notFoundTitle: `${appName} - 404 Page not found.`,
            waitingRoomTitle: `${appName} - Waiting for host to start the meeting`,
