...
let brand = {
    ...
    site: {
        ...
        landingTitle: 'CineTalk a Free Secure Video Calls, Chat & Screen Sharing.',
        newCallTitle: 'CineTalk a Free Secure Video Calls, Chat & Screen Sharing.',
        newCallRoomTitle: 'Pick name. <br />Share URL. <br />Start conference.',
        newCallRoomDescription:
            "Each room has its disposable URL. Just pick a room name and share your custom URL. It's that easy.",
        loginTitle: 'CineTalk - Host Protected login required.',
        loginHeading: 'Welcome back',
        loginDescription: 'Enter your credentials to continue.',
        loginButtonLabel: 'Login',
        joinRoomTitle: 'Pick name.<br />Share URL.<br />Start conference.',
        joinRoomButtonLabel: 'JOIN ROOM',
        clientTitle: 'CineTalk WebRTC Video call, Chat Room & Screen Sharing.',
        privacyPolicyTitle: 'CineTalk - privacy and policy.',
        stunTurnTitle: 'Test Stun/Turn Servers.',
        notFoundTitle: 'CineTalk - 404 Page not found.',
        waitingRoomTitle: 'CineTalk - Waiting for host to start the meeting',
...
function handleBrand() {
    ...
    if (footerCopyright && brand.app?.name) {
        footerCopyright.innerHTML = `&copy; ${new Date().getFullYear()} ${brand.app.name}, all rights reserved`;
    }
